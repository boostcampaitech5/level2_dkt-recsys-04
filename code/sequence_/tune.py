...
def main(args, train_loader, valid_loader, model, optimizer, scheduler):
    # seed 설정
    ...
    space = {  
        ...
        "lr": hp.uniform("lr", 0.00001, 0.005),
...
if __name__ == "__main__":
    ...
    main(args, train_loader, valid_loader, model, optimizer, scheduler)
